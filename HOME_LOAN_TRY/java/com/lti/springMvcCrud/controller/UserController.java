...
import com.lti.springMvcCrud.service.UserService;
...
public class UserController {
	...
	public ModelAndView displayNewUserForm() {
		...
		mv.addObject("user", new Author());
		return mv;
	}

	@RequestMapping(value = "/addUser", method = RequestMethod.POST)
	public ModelAndView saveNewUser(@ModelAttribute Author user, BindingResult result) {
